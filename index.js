...
// Attacher.  If a destination processor is given, runs the destination with
// the new nlcst tree (bridge-mode).  If a parser is given, returns the nlcst
// tree: further plugins run on that tree (mutate-mode).
...
// Bridge-mode.  Runs the destination with the new nlcst tree.
